...
def parse_args():
    ...
    parser.add_argument("--model", default="/root/autodl-tmp/nanodet/workspace/nanodet_m/model_best/nanodet_model_best.pth", help="model file path")
    parser.add_argument("--path", default="./demo", help="path to images or video")
    parser.add_argument("--camid", type=int, default=0, help="webcam demo camera id")
    parser.add_argument(
        "--save_result", default="./demo",
...
def main():
    ...
    if args.demo == "image":
        ...
        for image_name in files:
            ...
            #print("result_image is ", result_image)
            #print("this is 3!")
            if args.save_result:
